...
def test_jvm_suspend_adapter_descriptor_retains_completion_token():
    ...
    generated = render_jvm_feature_jsi(
        JvmSourceManifest(FEATURE, "3.0.0.dev0", (owner,)),
        api,
        feature_id=FEATURE,
        module_name="Drawing",
    )
    ...
    assert "supernote_v3_jvm_to_js_" in generated
...
def test_jvm_suspend_nullable_result_accepts_a_null_jobject():
    ...
    js_identity_lookup = generated.index(
        "supernote_v3_jvm_object_registry(runtime)", scheduled
    )
    ...
    assert "supernote_v3_jvm_object_registry" not in worker
...
def test_jvm_object_codegen_emits_nominal_wrappers_converters_and_registry():
    ...
    api = project_jvm_owners(owners, feature_id=FEATURE)
    generated = render_jvm_feature_jsi(
        JvmSourceManifest(FEATURE, "3.0.0.dev0", owners),
        api,
        feature_id=FEATURE,
        module_name="Drawing",
    )

    assert "class GeneratedV3JvmObject0HostObject final" in generated
    assert ": public JvmObjectHandleBase" in generated
    assert "try_extract_jvm_object" in generated
    assert "supernote_v3_wrap_jvm_object_0" in generated
    assert "std::make_shared<JvmObjectRegistry>()" in generated
    assert "__supernoteV3JvmObjectRegistry_2cfbc9ce6375" in generated
    assert "jvm-v3-value-constructor:" in generated
    assert "jvm-v3-enum-from:" in generated
    assert "jvm-v3-field-get:" in generated
    assert "jvm-v3-field-set:" in generated
    ...
    assert "supernote_v3_jvm_object_registry(runtime)" in generated
    ...
    assert "supernote_v3_jvm_validate_js_" in generated
