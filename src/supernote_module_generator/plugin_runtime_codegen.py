...
['Debug', 'Release'].each {{ buildVariant ->
    ...
    def commonTask = tasks.register("generateSupernote${{buildVariant}}Semantics", Exec) {{
        ...
        inputs.dir(layout.buildDirectory.dir("generated/ksp/${{variantName}}/resources"))
