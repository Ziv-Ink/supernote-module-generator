...
def _values(config: ProjectConfig) -> dict[str, str]:
    ...
    return {
        ...
        "ANNOTATION_FQCN": f"{config.android_namespace}.nativemodule.annotation.SupernoteExport",
...
_KOTLIN_FILES = {
    ...
    "android/.native-module/annotation/src/main/java/$PACKAGE_PATH/nativemodule/annotation/SupernoteExport.java": "SupernoteExport.java.tmpl",
